		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#sapuiinventory-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapuiinventory-display": {
								"semanticObject": "sapuiinventory",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.ui.inventory",
									"url": sap.ui.require.toUrl("sap/ui/inventory")
								}
							}
						}
					}
